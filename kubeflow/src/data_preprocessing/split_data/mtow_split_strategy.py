...
class MTOWSplitStrategy(SplitDataStrategy):
    ...
    def split(self, df: pd.DataFrame, **kwargs) -> Dict[
        ...
        result = {'very_low': self.process_subset(
            narrow_body_df[narrow_body_df['MTOW_range'] == 'Very Low'],
            is_test), 'low': self.process_subset(
            ...
            'medium': self.process_subset(
                ...
                is_test), 'high': self.process_subset(
                narrow_body_df[narrow_body_df['MTOW_range'] == 'High'],
                is_test), 'non_b77w': self.process_subset(
                wide_body_df[wide_body_df['MTOW_range'] == 'NonB77W'],
                is_test), 'b77w': self.process_subset(
