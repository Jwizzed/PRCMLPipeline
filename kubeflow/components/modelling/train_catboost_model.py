...
@component(
    ...
    packages_to_install=["catboost", "pandas", "scikit-learn", "numpy", "joblib"],
)
def train_catboost_model(
    ...
    if find_best_parameters:
        ...
        best_model = CatBoostRegressor(
            random_state=42, depth=9, iterations=2000, learning_rate=0.15
        )
        best_model.fit(X_train, y_train, eval_set=(X_test, y_test), verbose=100)
        best_params = {"depth": 9, "iterations": 2000, "learning_rate": 0.15}
    ...
    metrics = {"model_name": model_name, "rmse": rmse, "best_parameters": best_params}
